...
const Shorten = () => {
  return (
    <div className="bg-[#101010] w-full">
      <section className="md:flex-row md:px-10 flex flex-col gap-2 justify-between items-center px-2 pt-10 mx-auto max-w-6xl">
        <h4 className="text-3xl font-bold text-center text-white">
          SHORTEN YOUR LINK NOW
        </h4>
        <form
          className="flex flex-row justify-center items-center p-1 bg-gray-800 rounded-lg"
