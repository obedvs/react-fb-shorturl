...
const ButtonLoading = ({
  ...
  return (
    <button
      disabled
      type="button"
      className={`text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full sm:w-auto inline-flex items-center ${buttonColors[color]}`}
    >
      <svg
        aria-hidden="true"
        role="status"
        className="me-3 inline w-4 h-4 text-white animate-spin"
        viewBox="0 0 100 101"
        fill="none"
